...
echo   0: Reset to system default (equivalent to 1 in most cases)
echo   1: Default memory allocation for NTFS caching (recommended for standard systems)
echo   2: Increased memory allocation for better performance (best for systems with 16GB+ RAM, but may consume more kernel memory)
:mem_prompt
